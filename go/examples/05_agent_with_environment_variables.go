...
func main() {
	...
	if err != nil {
		log.Fatalf("Failed to create GITHUB_TOKEN: %v", err)
	}
	...
	if err != nil {
		log.Fatalf("Failed to create AWS_REGION: %v", err)
	}
	...
	if err != nil {
		log.Fatalf("Failed to create LOG_LEVEL: %v", err)
	}
	...
	if err != nil {
		log.Fatalf("Failed to create SLACK_BOT_TOKEN: %v", err)
	}
	...
	if err != nil {
		log.Fatalf("Failed to create OPENAI_API_KEY: %v", err)
	}
