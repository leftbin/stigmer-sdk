...
// Package examples demonstrates how to create workflows using the Stigmer SDK (LEGACY VERSION).
//
// This is the legacy version showing the old API without typed context.
// For the new typed context version, see 07_basic_workflow.go
package main
...
// LEGACY EXAMPLE: This demonstrates the old workflow API without typed context.
// For the new typed context API, see 07_basic_workflow.go
//
