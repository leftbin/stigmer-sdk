...
Currently available in the [Stigmer monorepo](https://github.com/leftbin/stigmer/tree/main/sdk/python). Migration to this public repository is planned for a future release.
...
- **Buf Schema Registry**: [buf.build/leftbin/stigmer](https://buf.build/leftbin/stigmer)
- **Main Repository**: [github.com/leftbin/stigmer](https://github.com/leftbin/stigmer)
